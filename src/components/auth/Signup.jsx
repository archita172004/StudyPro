...
const Signup = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      {/* Content */}
      <div className="relative z-10 flex w-full max-w-5xl items-center justify-between px-8 py-12">
        {/* Left: Logo */}
        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-8 flex flex-col">
          ...
          <form className="space-y-4">
            ...
            <div>
              ...
              <select className="mt-1 w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
